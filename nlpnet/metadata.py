...
class Metadata(object):
    ...
    def save_to_file(self):
        '''
        Save the contents of the metadata to a file.
        The filename is determined according to the task.
        '''
    ...
    def load_from_file(cls, task, paths=None):
        ...
        # the actual content of the file is
        # the __dict__ member variable, which contain all
        # the instance's data
