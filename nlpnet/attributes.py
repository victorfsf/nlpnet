...
class Token(object):
    ...
    def __init__(self, word, lemma='NA', pos='NA',
                 pos2='NA', morph='NA', chunk='NA'):
        '''
    ...
    def load_affixes(cls, codes, filename):
        ...
        for size in affixes_by_size:
            ...
            codes[size] = {affix: code
                           for code, affix in
                           enumerate(affixes_by_size[size], 2)}
...
class TokenConverter(object):
    ...
    def add_extractor(self, extractor):
        ...
        In order to get a token's feature indices,
        the Converter will call each of its extraction functions passing
